    ...
    var allChapters: [Chapter] = [
        Chapter(1, passages: [
            ...
            ["Chân Lý và Tình Yêu": """
                ...
                5 Bây giờ, thưa bà, tôi xin bà điều nầy, không phải tôi viết cho bà một điều răn mới, nhưng là điều răn chúng ta đã nhận được từ ban đầu, đó là chúng ta phải yêu thương nhau.
                ...
                9 Ai bỏ đi và không ở trong sự dạy dỗ của Ðấng Christ thì không có Ðức Chúa Trời; nhưng người cứ ở trong sự dạy dỗ ấy thì có cả Ðức Chúa Cha và Ðức Chúa Con.  10 Nếu ai đến với anh chị em mà không đem sự dạy dỗ nầy theo, thì đừng tiếp người ấy vào nhà, và cũng đừng hoan nghinh người ấy, 11 vì hoan nghinh người ấy tức là dự phần vào việc xấu của người ấy.
