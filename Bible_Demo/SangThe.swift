...
class SangThe: Book {
    ...
    fileprivate let allChapters: [Chapter] = [
        ...
        Chapter(7, passages: [
            ["Cơn Ðại Hồng Thủy": """
                1 Bấy giờ CHÚA truyền cho Nô-ê, “Ngươi hãy vào tàu, ngươi và mọi người trong gia đình ngươi, vì Ta thấy rằng giữa thế hệ này chỉ có ngươi là ngay lành trước mặt Ta.  2 Hãy đem theo ngươi bảy cặp mọi thứ thú vật thanh sạch, có đực có cái; còn những thú vật không thanh sạch mỗi thứ một cặp, có đực có cái.  3 Các chim trời cũng vậy, mỗi thứ bảy cặp, có trống có mái, để bảo tồn mạng sống của chúng trên khắp mặt đất.  4 Vì trong bảy ngày nữa Ta sẽ cho mưa xuống đất trong bốn mươi ngày và bốn mươi đêm, rồi Ta sẽ xóa sạch khỏi mặt đất mọi sinh vật Ta đã dựng nên.”  5 Nô-ê làm theo mọi điều CHÚA đã truyền cho ông.
