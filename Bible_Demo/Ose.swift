    ...
    var allChapters: [Chapter] = [
        ...
        Chapter(3, passages: [
            ["Ân Sủng của CHÚA Ðối Với Kẻ Bất Trung": """
                ...
                4 Thật vậy dân I-sơ-ra-ên sẽ trải qua một thời gian dài không vua, không người lãnh đạo, không của tế lễ, không trụ thờ, không ê-phốt, và không thần riêng của gia đình.  5 Sau đó dân I-sơ-ra-ên sẽ quay về và tìm kiếm CHÚA, Ðức Chúa Trời của họ, và Ða-vít vua họ.  Họ sẽ kính sợ CHÚA và vui về phước hạnh của Ngài trong những ngày sau.
