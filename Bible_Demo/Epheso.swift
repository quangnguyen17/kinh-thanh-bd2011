    ...
    var allChapters: [Chapter] = [
        ...
        Chapter(6, passages: [
            ...
            ["Khí Giới của Ðức Chúa Trời": """
                10 Sau cùng, anh chị em hãy mạnh mẽ trong Chúa và trong sức toàn năng của Ngài.  11 Hãy mang vào toàn bộ khí giới của Ðức Chúa Trời, để anh chị em có thể đứng vững mà đối phó với những mưu chước của Ác Quỷ, 12 vì không phải chúng ta chiến đấu với loài có thịt và máu, nhưng với những quyền lực vô hình, những quyền lực thống trị, những quyền lực tối tăm trong vũ trụ nầy, và những quyền lực của các tà linh trên trời.
