...
class ITimothe: Book {
    ...
    var allChapters: [Chapter] = [
        Chapter(1, passages: [
            ["Lời Chào Thăm": """
                1 Phao-lô, một sứ đồ của Ðức Chúa Jesus Christ, theo lịnh của Ðức Chúa Trời, Ðấng Giải Cứu chúng ta, và của Ðức Chúa Jesus Christ, hy vọng của chúng ta, 2 gởi cho Ti-mô-thê, con thật của ta trong đức tin.  Nguyện xin ân sủng, thương xót, và bình an từ Ðức Chúa Trời, Cha chúng ta, và từ Ðức Chúa Jesus Christ, Chúa chúng ta, đến với con.
        ...
        Chapter(2, passages: [
            ["Cầu Nguyện cho Mọi Người": """
                1 Vậy trước hết, ta khuyên con hãy cầu xin, khẩn nguyện, cầu thay, và cảm tạ cho mọi người, 2 cho các vua và tất cả những người cầm quyền, để chúng ta có thể sống một đời bình tịnh và êm ả, trong nếp sống đạo vẹn toàn và đầy phẩm giá.  3 Ðây là điều tốt đẹp và vui lòng trước mặt Ðức Chúa Trời, Ðấng Giải Cứu của chúng ta; 4 Ngài muốn mọi người được cứu và tiến đến sự nhận biết chân lý.
            ...
            ["Nam Nữ Trong Hội Thánh Khi Nhóm Lại Thờ Phượng Chúa": """
                8 Vậy ta muốn quý ông hãy cầu nguyện ở mọi nơi, đưa đôi tay thánh sạch lên, đừng giận dữ và cãi nhau.
        ...
        Chapter(6, passages: [
            ...
            ["Lời Khuyên Những Người Giàu": """
                ...
                """],
            ["Lời Dặn Dò Cuối Thư": """
                20 Ti-mô-thê con, hãy giữ những gì đã ủy thác cho con, hãy tránh xa những chuyện hư không báng bổ và những cuộc tranh luận nhằm chống đối ngụy xưng là tri thức.  21 Vì muốn cho mình là người có thứ tri thức ấy, một số người đã mất đức tin.
